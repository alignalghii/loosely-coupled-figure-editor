...
FourierMotzkinEliminationBehavior.prototype.shouldTestFourierMotzkinEliminationBehavior = function () {return this.shouldConstraintLastVar() && this.shouldEliminateVar1() && this.shouldEliminateAllVars() && this.shouldEliminateAllVarsButOne() && this.shouldEliminateNVars() && this.shouldPartitionateByNormalization() && this.shouldTagByNormalization() && this.shouldDecideNormalizationRule() && this.shouldDispatch() && this.shouldRecombine() && this.shouldTruncateSys() /*&& this.shouldTruncableSys()@TODO*/ && this.shouldPredicateForIncludingBoundary() && this.shouldPredicateForExcludingBoundary() && this.shouldPredicateForExactBoundary() && this.shouldGlobalPredicateForIncludingBoundary() && this.shouldGlobalPredicateForExcludingBoundary() && this.shouldGlobalPredicateForExactBoundary() && this.shouldIneqSystemCharacteristic() && this.shouldQuantifyCharacteristic() && this.shouldAssembleConstraint() && this.shouldLowConstraint() && this.shouldHighConstraint() && this.shouldNullConstraint() && this.shouldSysVarCount();};
