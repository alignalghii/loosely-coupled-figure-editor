onload = function (event)
{
	...
	const svgLowLevel_workCanvas   = new SvgLowLevel(document, 'svgRoot_workCanvas'  ); // [600, 400] // [750, 500] // [900, 500]
	const svgLowLevels = [
	...
	const coordSysTransformer_workCanvas   = new CoordSysTransformer([450, 250], 20, [true, false]); // eredeti adat: new CoordSysTransformer([300, 200], 10, [true, false])
