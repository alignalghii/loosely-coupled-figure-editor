...
VerticePathClickAlgebraBehavior.prototype.shouldTestVerticePathClickAlgebraBehavior = function () {return this.shouldAddVertex_degenerate() && this.shouldAddVertex && this.shouldDeleteVertex() && this.shouldMoveVertex();};

VerticePathClickAlgebraBehavior.prototype.shouldAddVertex_degenerate    = () => vecEq(addVertex   ([[-5, -5],          [-5, 5], [5, 5], [-5, 5]], [0, -6]), [[-5, -5], [-5, 5], [5, 5], [-5, 5]]);
