function BatteringRamWidgetFactory (canvasPseudoWidget, svgLowLevel, coordSysTransformer, bijectionSvgToGeom) {WidgetFactory.call(this, canvasPseudoWidget, svgLowLevel, coordSysTransformer, bijectionSvgToGeom);}

BatteringRamWidgetFactory.prototype = Object.create(WidgetFactory.prototype);

BatteringRamWidgetFactory.prototype.constructor = BatteringRamWidgetFactory;


BatteringRamWidgetFactory.prototype.createFromBusiness = function (businessObject) {throw 'Disabled inheritance';}; // @TODO ,,Néma kacsa'' öröklődési probléma
...
BatteringRamWidgetFactory.prototype.calculate = function ([width, height], [x, y]) // @TODO DRY: same as in ImageWidgetFactory
{
...
/*
BatteringRamWidgetFactory.prototype.composeFromHigh = function (high) {};

BatteringRamWidgetFactory.prototype.composeFromLow  = function (low) {};
