function ScaleStressSpanLog(arcCalculator, [A, O, A_], figRefAngle, maybeVain)
{
...
ScaleStressSpanLog.prototype.message = function ()
{
	...
	return maybe(
		...
		vain => formatVectorsAndConverseToDegree2`Kifeszítendő AOA'∡ forgatásív irányszöge: ${AOA_} (+ ${vain} sikertelen) [ref: ${figRefAngle}] (O: ${O}, A: ${A}, A': ${A_}). Ütközés, esetleges visszapattanással!`,
		maybeVain
	);
};
...
function formatVectorsAndConverseToDegree2(strings, ...vecs)
{
	var msg = '';
	for (let i in vecs) {
